...
const routes: Routes = [
  ...
  { path: 'memory', loadComponent: () => import('./app/memory.component').then((m) => m.MemoryComponent) },
  { path: 'sandbox', loadComponent: () => import('./app/sandbox.component').then((m) => m.SandboxComponent) },
